...
model_filename = '/acmenas/hakrami/3D_lesion_DF/models/half_3Q/model_epoch1298.pt'
model.to(device)
...
for epoch in range(n_epochs):
    ...
    if (epoch + 1) % val_interval == 0:
        ...
        filename = f"./results/half_norm_3Q_4d/sample_epoch{epoch+st}.png"
        ...
        # Save the model
        model_filename = f"./models/half_3Q_4d/model_epoch{epoch+st}.pt"
