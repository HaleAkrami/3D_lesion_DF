...
cp -r  $INPUT_DIR/t2  $DATA_DIR/v2skullstripped/HCP/
...
echo "Register t2"
python registration_v2.py -i $DATA_DIR/v2skullstripped/HCP/t1 -o $DATA_DIR/v3registered_non_iso/HCP/t1 --modality=_t1 -trans Affine -templ sri_atlas/templates/T1_brain.nii
